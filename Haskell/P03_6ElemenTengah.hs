...
-- Deskripsi : Memberikan elemen tengah list
...
-- REALISASI
elemenTengah l
	| (isOneElmt l) || (isOneElmt (tail l)) = last l						--BASIS
	| otherwise								= elemenTengah (tail (init l))	--REKURENS

-- APLIKASI
-- elemenTengah [1,3,5,7,9] = 5
-- elemenTengah [2,4,8,10] 	= 8
-- elemenTengah [7] 		= 7
